...
<div id="default-carousel" class="relative w-full" data-carousel="static">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-72">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ $image_1 }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        @if ($image_2)
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{ $image_2 }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
        @endif
    </div>
    <!-- Slider controls -->
