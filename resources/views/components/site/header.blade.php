...
<nav class="fixed top-0 z-50 w-full mb-16 bg-white border-b border-gray-200 dark:bg-gray-900 start-0 dark:border-gray-600">
    ...
    <div class="flex gap-4">
        <a href="{{ route('site') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Marco Antônio</span>
        </a>
        ...
        <button
            ...
            focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-4 border border-gray-600">
    ...
    <div class="hidden w-full md:block md:w-auto " id="navbar-default">
      <ul class="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
            <a href="{{ route('site') }}"
                class="block px-3 py-2 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">
                Home
            </a>
        </li>
